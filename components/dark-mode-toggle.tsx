...
export default function DarkModeToggle() {
  ...
  return (
    <button
      ...
      className="fixed top-4 right-4 sm:top-6 sm:right-6 z-[100] bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-full p-3 sm:p-4 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-110 border border-gray-200 dark:border-gray-600 ring-1 ring-black/5 dark:ring-white/10 group"
